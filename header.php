                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            ?>"><a class="hvr-underline-from-center" href="index.php">Home</a></li>
                            <li class="<?php
                            if ($currentPage == 'whyus') {
                                echo 'active';
                            }
                            ?>"><a class="hvr-underline-from-center" href="whyus.php">Why Us</a></li>
                            <li class="<?php
                            if ($currentPage == 'price') {
                                echo 'active';
                            }
                            ?>"><a class="hvr-underline-from-center" href="price.php">Pricing</a></li>
                            <li class="<?php
                            if ($currentPage == 'buzzar') {
                                echo 'active';
                            }
                            ?>"><a class="hvr-underline-from-center" href="buzzar.php">Buzzar</a></li>
                            <li class="<?php
                            if ($currentPage == 'blog') {
                                echo 'active';
                            }
                            ?>"><a class="hvr-underline-from-center" href="blog.php">Blog</a></li>
                            <li class="<?php
                            if ($currentPage == 'career') {
                                echo 'active';
                            }
                            ?>"><a class="hvr-underline-from-center" href="career.php">Career</a></li>
                            <li class="<?php
                            if ($currentPage == 'contact') {
                                echo 'active';
                            }
                            ?>"><a class="hvr-underline-from-center" href="contact.php">Contact</a></li>
