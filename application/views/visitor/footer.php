        ...
        <div class="row footer-slide">
            <div class="col-lg-4 col-md-6">
                ...
                <div class="store-btn mt30">
                    <a href="#"><img src="<?php echo base_url(); ?>include_files/user/images/app-store.png" alt="download app store"></a>
                    <a href="#"><img src="<?php echo base_url(); ?>include_files/user/images/google-play.png" alt="download google play"></a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
